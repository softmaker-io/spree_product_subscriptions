...
::Spree::PermittedAttributes.line_item_attributes << :subscribe
::Spree::PermittedAttributes.line_item_attributes << :delivery_number
::Spree::PermittedAttributes.line_item_attributes << :subscription_frequency_id
